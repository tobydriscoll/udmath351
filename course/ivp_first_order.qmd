...
::::{#exm-preview-rewrite chapter=1 description="1st-order ODE standard form"}
The equation
...
::::{#exm-preview-verify chapter=1 description="Verify ODE solution"}
...
The solution @eq-preview-const-growth-solution again has an arbitrary constant. Unlike for @eq-preview-constant-change, however, this constant appears as a multiplier, not as an addend. It turns out that we will always get such a constant popping up in some form, which leads to the following definition:
...
:::{#exm-preview-var-growth chapter=1 description="Variable-growth ODE solution"}
...
::::{#exm-preview-nonlinear chapter=1 description="Nonlinear growth ODE solution"}
...
<!-- ```{index} particular solution, ! initial-value problem; with first-order ODE
``` -->
...
:::: {#exm-ivp1-solve chapter=1 description="Solve 1st-order IVP"}
Solve the IVP
...
:::: {#exm-ivp1-plot chapter=1 description="Solution curves and an initial condition"} 
...
::::{#exm-ivp1-numerical-constant chapter=1 description="Numerical solution for constant growth rate"}
# Constant growth
...
::::{#exm-ivp1-numerical-variable chapter=1 description="Numerical solution for variable growth rate"}
# Variable growth
...
::::{#exm-ivp1-numerical-nonlinear chapter=1 description="Numerical solution for nonlinear growth"}
# Nonlinear
...
::::{#exm-qualitative-logistic chapter=1 description="Logistic equation direction field"}
...
<!-- ```{index} autonomous equation
``` -->
::::{#exm-qualitative-timevarying chapter=1 description="Direction field for nonautonomous equation"}
...
::::{#exm-qualitative-equilibria chapter=1 description="Phase diagram for stability of equilibria"} 
...
::::{#exm-separable-vargrowth chapter=1 description="Separable equation"}
...
::::{#exm-separable-implicit chapter=1 description="Separable equation---implicit solution"} 
...
::::{#exm-separable-factor chapter=1 description="Separable equation---factorization"}
...
::::{#exm-separable-autonomous chapter=1 description="Separable equation---autonomous"}
...
::::{#exm-linear-operator chapter=1 description="Linear operator"}
The equation
...
::::{#exm-homog1-sin chapter=1 description="1st order homogeneous solution"}
Solve $x'=\sin(t) x$. 
...
::::{#exm-homog1-power chapter=1 description="1st order homogeneous solution"}
...
::::{#exm-homog1-singular chapter=1 description="1st order homogeneous solution"}
...
@sec-first-order-homogeneous1 explained how to find the general solution $x_h(t)$ of a homogeneous linear system $\opA[x] = 0$. The next step of our solution strategy in @thm-linear-solve is to find some particular solution of $\opA[x]=f$ for the given $f(t)$. After that, the general solution is in our hands.
...
To find the general solution of $\opA[x]=f$, compute the following, ignoring constants of integration:
...
::::{#exm-vop-one chapter=1 description="1st order variation of parameters"}
Solve $3x'=12x+24t$.
...
::::{#exm-vop-two chapter=1 description="1st order variation of parameters"}
...
::::{#exm-vop-three chapter=1 description="1st order variation of parameters"}
Solve the IVP
...
![](integrating_factor.jpg)

A different process for arriving at the solution to a linear first-order ODE goes by the name of the **integrating factor**. Mathematically and computationally, it's identical to @thm-linear-solve, but organized slightly differently. 
...
::::{#exm-modeling-bacteria chapter=1 description="Bacterial growth model"}
...
::::{#exm-modeling-radioactive chapter=1 description="Radioactive decay model"}
...
::::{#exm-modeling-coffee chapter=1 description="Cooling coffee model"}
...
::::{#exm-modeling-flintstones chapter=1 description="Cooling coffee model"}
